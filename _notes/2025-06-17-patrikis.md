...
These are notes taken for Stefan Patrikis's course on the arithmetic of curves at Ross/Ohio 2025, with supplemental appendices on some commutative algebra. 

A course description is as follows: Local-global principles for rational points on curves. Counting points over
...
first-year material. Notes, which have some typos and errors, can be found [here](https://karthikp-2100.github.io/files/Ross2025PatrikisDraft.pdf). 
